# 🚀 DemoAi - Generated Microservice Platform
...
- [ ] Open a terminal and run:
  ```bash
  git clone https://github.com/QuickCodeNet/demo-ai.git
  ```
...
- [ ] In a new terminal, run all tests:
  ```bash
  dotnet test QuickCode.DemoAi.Docker.sln
  ```
...
**DemoAi** is a modular, enterprise-grade .NET solution generated by [quickcode.net](https://quickcode.net).  
...
demo-ai/
  src/
    ...
    Modules/
      ...
      IdentityModule/
    Presentation/
      QuickCode.DemoAi.Gateway/
      QuickCode.DemoAi.Portal/
    Services/
    ...
  docker-compose.yml
  README.md
...
- Architecture Diagram:
  ![Architecture Diagram](https://www.quickcode.net/diagram/demo-ai)
...
- **Gateway Dashboard:**
    ...
    - Your project: e.g. [https://demo-ai-gateway.quickcode.net](https://demo-ai-gateway.quickcode.net)
...
- **Portal Dashboard:**
    ...
    - Demo user credentials:
        - Username : demo@quickcode.net
        - Password : String1!
    - Your project: e.g. [https://demo-ai-portal.quickcode.net](https://demo-ai-portal.quickcode.net)
...
- **Gateway:**
    - link: [https://demo-ai-gateway.quickcode.net](https://demo-ai-gateway.quickcode.net)
- **Portal:**
    - link: [https://demo-ai-portal.quickcode.net](https://demo-ai-portal.quickcode.net)
- **Module APIs:**
    - link: [https://demo-ai-identity-module.quickcode.net](https://demo-ai-identity-module.quickcode.net)
    - etc.
...
```json
{
  "Routes": {
    "identity-module": {
      "Match": {
        "Hosts": ["demo-ai-gateway.quickcode.net"],
  ...
  "Clusters": {
    "identity-module-api": {
      "Destinations": {
        "destination1": {
          "Address": "https://demo-ai-identity-module.quickcode.net"
        }
      }
    }
  }
...
**Last generation Time**: [Generated on: 2026-03-09 12:48:49 UTC]