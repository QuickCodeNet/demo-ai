...
using Moq;
using QuickCode.DemoAi.ProductCatalogModule.Persistence.Repositories;
...
namespace QuickCode.DemoAi.ProductCatalogModule.Persistence.Tests.Repositories
{
    public class ProductCategoryRepositoryTests : IDisposable
    {
        ...
        public async Task InsertAsync_Should_Generate_Unique_Ids()
        {
            ...
            Assert.NotEqual(result1.Value.ProductId, result2.Value.ProductId);
        }
        ...
        public async Task GetByPkAsync_Should_Return_Item_When_Exists()
        {
            ...
            // Act
            var result = await repository.GetByPkAsync(insertedItem.Value.ProductId, insertedItem.Value.CategoryId);
            // Assert
            Assert.Equal(ResultCodeSuccess, result.Code);
            itemDto.AssertPropertiesEqual(result.Value);
        }
        ...
        public async Task GetByPkAsync_Should_Return_NotFound_When_Item_Not_Exists()
        {
            ...
            // Act
            var result = await repository.GetByPkAsync(notExistsItem.ProductId, notExistsItem.CategoryId);
            // Assert
        ...
        public async Task UpdateAsync_Should_Update_Item_Successfully()
        {
            ...
            var updates = insertedItem.GenerateRandomUpdates(["ProductId", "CategoryId"]);
            ...
            var updatedItem = await repository.GetByPkAsync(insertedItem.ProductId, insertedItem.CategoryId);
        ...
        public async Task DeleteAsync_Should_Delete_Item_Successfully()
        {
            ...
            var deletedItem = await repository.GetByPkAsync(insertedItem.Value.ProductId, insertedItem.Value.CategoryId);
