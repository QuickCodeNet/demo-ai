...
using QuickCode.DemoAi.ProductCatalogModule.Api.Controllers;
using QuickCode.DemoAi.ProductCatalogModule.Application.Dtos.AuditLog;
using QuickCode.DemoAi.ProductCatalogModule.Application.Services.AuditLog;
using System.Collections.Generic;
using QuickCode.DemoAi.Common.Models;
using QuickCode.DemoAi.Common.Helpers;

namespace QuickCode.DemoAi.ProductCatalogModule.Api.Tests
{
