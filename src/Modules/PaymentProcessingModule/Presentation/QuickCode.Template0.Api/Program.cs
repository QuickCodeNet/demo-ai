...
using QuickCode.Template0.Persistence.Contexts;
using System.Text.Json.Serialization;
using QuickCode.TemplateCommon.Common;
using QuickCode.TemplateCommon.Common.Filters;
using QuickCode.TemplateCommon.Common.Helpers;
using Microsoft.AspNetCore.Diagnostics.HealthChecks;
using HealthChecks.UI.Client;
using Microsoft.AspNetCore.Mvc.ApplicationModels;
using QuickCode.TemplateCommon.Common.Models;
using QuickCode.TemplateCommon.Common.Nswag.Extensions;
using QuickCode.TemplateCommon.Common.Extensions;
using QuickCode.TemplateCommon.Common.Mappers;
using Serilog;
...
using QuickCode.TemplateCommon.Common.Auditing;
using QuickCode.TemplateCommon.Common.Middleware;
using QuickCode.TemplateCommon.Common.ExceptionHandling;
...
builder.Services.AddOpenTelemetry()
    .ConfigureResource(resource => resource
        .AddService(serviceName: "QuickCode.Template0.Api"))
