...
using LoginRequest = QuickCode.Template0.Common.Nswag.Clients.IdentityModuleApi.Contracts.LoginRequest;


using ForgotPasswordRequest = QuickCode.Template0.Common.Nswag.Clients.IdentityModuleApi.Contracts.ForgotPasswordRequest;
using ResetPasswordRequest = QuickCode.Template0.Common.Nswag.Clients.IdentityModuleApi.Contracts.ResetPasswordRequest;
