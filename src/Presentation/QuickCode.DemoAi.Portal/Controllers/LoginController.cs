...
using LoginRequest = QuickCode.DemoAi.Common.Nswag.Clients.IdentityModuleApi.Contracts.LoginRequest;


using ForgotPasswordRequest = QuickCode.DemoAi.Common.Nswag.Clients.IdentityModuleApi.Contracts.ForgotPasswordRequest;
using ResetPasswordRequest = QuickCode.DemoAi.Common.Nswag.Clients.IdentityModuleApi.Contracts.ResetPasswordRequest;
