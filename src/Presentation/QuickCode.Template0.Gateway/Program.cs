...
using QuickCode.Template0.Common;
using QuickCode.Template0.Common.Extensions;
using QuickCode.Template0.Gateway.Messaging;
...
using QuickCode.Template0.Common.Controllers;
using Yarp.ReverseProxy.Transforms;
using QuickCode.Template0.Common.Helpers;
using QuickCode.Template0.Common.Nswag;
using QuickCode.Template0.Common.Nswag.Extensions;
using QuickCode.Template0.Gateway.Models;
using QuickCode.Template0.Gateway.Extensions;
using QuickCode.Template0.Gateway.KafkaProducer;
using Serilog;
using QuickCode.TemplateCommon.Common.Middleware;
using QuickCode.TemplateCommon.Gateway.Middleware;

using InMemoryConfigProvider = QuickCode.Template0.Gateway.Extensions.InMemoryConfigProvider;
